...
supabase.table('proc_def').upsert(
    {'id': 'company_entrance', 'name': '신입사원 입사처리 프로세스', 'definition': {
        "processDefinitionName": "신입사원 입사처리 프로세스",
        "processDefinitionId": "company_entrance",
        "description": "신입사원 입사처리 프로세스",
        "data": [
            {
...
supabase.table('proc_def').upsert(
    {'id': 'vacation_request', 'name': '휴가 신청 프로세스', 'definition': {
        "processDefinitionName": "휴가 신청 프로세스",
        "processDefinitionId": "vacation_request",
        "description": "휴가 신청 프로세스",
        "data": [
            {
...
supabase.table('proc_def').upsert(
    {'id': 'vacation_addition', 'name': '휴가 추가 프로세스', 'definition': {
        "processDefinitionName": "휴가 추가 프로세스",
